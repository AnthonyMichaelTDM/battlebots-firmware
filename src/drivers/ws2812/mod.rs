//! Driver for the on-board WS2812B RGB LED on the ESP32-S3
//!
//! Based on the following resources:
//! - https://github.com/nguterresn/esp_ws2812_b/blob/master/lib/src/ws2812_b.rs
//!
//! which didn't work out of the box, hence this "forK".
...
pub struct WS2812B {
    ...
    green: u8,
    blue: u8,
    ch: Channel<Blocking, esp_hal::rmt::ConstChannelAccess<esp_hal::rmt::Tx, 0>>,
}
...
impl WS2812B {
    ...
    pub fn new(rmt: RMT, freq_mhz: u32, gpio: impl OutputPin) -> Result<Self, Error> {
        ...
        let channel: Channel<Blocking, esp_hal::rmt::ConstChannelAccess<esp_hal::rmt::Tx, 0>> =
            rmt.channel0.configure_tx(
                output,
